...
Закрытая управленческая панель для владельца салона. Она объединяет Google Ads,
Google Analytics 4, Altegio и Google Search Console и переводит технические
показатели в бизнес-метрики: расходы, записи, состоявшиеся визиты, фактическую
выручку, средний чек, загрузку и органический спрос.
...
- приложение Altegio `1591` активно, агрегированные отчёты подключены без
  сохранения контактов клиентов; панель показывает также разбиение оплат на
...
- [Итоги рекламы и бизнеса за 12 месяцев](docs/year-review-2025-09-to-2026-09.md)
